...
Welcome to ``Pindo`` contributor's guide.
...
If you experience bugs or general issues with ``Pindo``, please have a look
...
You can help improve ``Pindo`` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

``Pindo`` documentation uses Sphinx_ as its main documentation compiler.
...
.. todo:: If your project is hosted on GitHub, you can also mention the following tip:
   ...
   .. tip::
      ...
      propose changes in ``Pindo``'s files. While this mechanism can
...
or Miniconda_::
    ...
    conda create -n Pindo python=3 six virtualenv pytest pytest-cov
    conda activate Pindo
...
#. Clone this copy to your local disk::
    ...
    git clone git@github.com:YourLogin/Pindo.git
    cd Pindo
...
#. Install |pre-commit|_::
   ...
   ``Pindo`` comes with a lot of hooks configured to automatically help the
...
.. _repository: https://github.com/<USERNAME>/Pindo
.. _issue tracker: https://github.com/<USERNAME>/Pindo/issues
.. <-- end -->
